      ...
      <div class="inrSigninBody bor flex fdc h100">
        ...
        <div class="signinContentCrate bor fg1 flex">
          ...
          <div class="signinFormCrate bor w50 flex fdc jcc">
            ...
            <form action="users?page=insert" method="post" class="signinFrom bor flex fdc" >
                <input type="text" class="signinInputs signinInputEmail ff1" placeholder="work email" name="Workemail">
                <input type="text" class="signinInputs signinInputEmail ff1" placeholder="password" name="Password">
              <div class="signinSigninCrate bor flex pb10">
              <input type="submit" value="Signin" class="signinButton totext ff1">

<!--                <a href="dashboard.jsp" value="signin" class="signinButton totext ff1">Sign In</a>-->
              </div>
